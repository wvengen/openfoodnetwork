  ...
  class EnterprisesController < ResourceController
    ...
    def index
      respond_to do |format|
        format.html
        format.json { render_as_json @collection, spree_current_user: spree_current_user }
      end
    end
    ...
    def collection
      ...
      when :for_line_items
        OpenFoodNetwork::Permissions.new(spree_current_user).order_cycle_enterprises.ransack(params[:q]).result
      else
